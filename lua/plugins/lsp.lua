return {
  {
    ...
    opts = function(_, opts)
      opts.servers = {
        ...
        tsserver = {
          keys = {
            ...
            { "<leader>ru", "<cmd>TypescriptRemoveUnused<CR>", desc = "Rename Unused" },
          },
          settings = {
            typescript = {
              inlayHints = {
      ...
      opts.setup = {
        rust_analyzer = function(_, opt)
          local rust_tools_opts = require("lazyvim.util").opts("rust-tools.nvim")
          require("rust-tools").setup(vim.tbl_deep_extend("force", rust_tools_opts or {}, { server = opt }))
          return true
        end,
